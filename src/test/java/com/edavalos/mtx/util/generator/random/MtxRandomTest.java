...
public class MtxRandomTest {
    private static final long SAMPLE_SEED = 69;
    private static final int TESTS_COUNT = 10;

    private MtxRandom mtxRandom;

    @BeforeEach
    public void setUp() {
        mtxRandom = new MtxRandom(SAMPLE_SEED) {};
    }
    ...
    public class RandomByteTests {
        ...
        public void setUp() {
            ...
            for (int i = 0; i < TESTS_COUNT; i++) {
                randomsList.add(mtxRandom.randomByte());
            }
    ...
    public class RandomShortTests {
        ...
        public void setUp() {
            randomsList = new ArrayList<>();
            for (int i = 0; i < TESTS_COUNT; i++) {
                randomsList.add(mtxRandom.randomShort());
            }
            randomsSet = new HashSet<>(randomsList);
        }
    ...
    public class RandomIntTests {
        ...
        public void setUp() {
            randomsList = new ArrayList<>();
            for (int i = 0; i < TESTS_COUNT; i++) {
                randomsList.add(mtxRandom.randomInt());
            }
            randomsSet = new HashSet<>(randomsList);
        }
        ...
        public void testRandomInt_withBounds() {
            for (int i = 0; i < TESTS_COUNT; i++) {
                ...
                for (int j = 0; j < TESTS_COUNT; j++) {
                    int randomSample = mtxRandom.randomInt(smallBound, largeBound);
    ...
    public class RandomLongTests {
        ...
        public void setUp() {
            randomsList = new ArrayList<>();
            for (int i = 0; i < TESTS_COUNT; i++) {
                randomsList.add(mtxRandom.randomLong());
            }
            randomsSet = new HashSet<>(randomsList);
        }
    ...
    public class RandomFloatTests {
        ...
        public void setUp() {
            randomsList = new ArrayList<>();
            for (int i = 0; i < TESTS_COUNT; i++) {
                randomsList.add(mtxRandom.randomFloat());
            }
            randomsSet = new HashSet<>(randomsList);
        }
    ...
    public class RandomDoubleTests {
        ...
        public void setUp() {
            randomsList = new ArrayList<>();
            for (int i = 0; i < TESTS_COUNT; i++) {
                randomsList.add(mtxRandom.randomDouble());
            }
            randomsSet = new HashSet<>(randomsList);
        }
    ...
    public class RandomCharTests {
        ...
        public void setUp() {
            randomsList = new ArrayList<>();
            for (int i = 0; i < TESTS_COUNT; i++) {
                randomsList.add(mtxRandom.randomChar());
            }
            randomsSet = new HashSet<>(randomsList);
        }
