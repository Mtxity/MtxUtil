...
public final class MtxRandomSelector {
    ...
    public static <T> MtxOptionalVar<T> pickRandom(T item1, T item2, T item3, T item4, T item5, T item6, T item7) {
        if (
        ...
        return switch (index) {
            ...
            case 4 -> MtxOptionalVar.ofNullable(item5);
            case 5 -> MtxOptionalVar.ofNullable(item6);
            case 6 -> MtxOptionalVar.ofNullable(item7);
            default -> MtxOptionalVar.empty();
        };
    }
